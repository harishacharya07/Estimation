...
public class WallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Laterite Wall");
        ...
        calulate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                double res = Math.round((l * f * 0.23) - (value));

                String result = "Calculated quantity is " + res + "m cube";
                tvres.setText(result);

                firebaseDatabase.getReference().child("Wall").child(userId).setValue(res);
                firebaseDatabase.getReference().child("steel").child(userId).setValue(op);
            }
        });
